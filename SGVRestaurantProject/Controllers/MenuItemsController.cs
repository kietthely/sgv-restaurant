...
namespace SGVRestaurantProject.Controllers
{
    ...
    public class MenuItemsController : Controller
    {
        ...
        public MenuItemsController(SVGRestaurantContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.MenuItems != null ? 
                          ...
                          Problem("Entity set 'SVGRestaurantContext.MenuItems'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,ItemName")] MenuItem menuItem)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SVGRestaurantContext.MenuItems'  is null.");
            }
            var menuItem = await _context.MenuItems.FindAsync(id);
            if (menuItem != null)
            {
